...
const UserManual = () => {
  const slideshowImages = [
    { src: img1, alt: "Dashboard Overview" },
    { src: img2, alt: "Chat Interface" },
    { src: img3, alt: "Document Management" },
    { src: img4, alt: "Settings Panel" },
    ...
    <div className="user-manual">
      <div className="container">
        ...
        <section className="slideshow-section" aria-labelledby="slideshow-title">
          <h2 id="slideshow-title" className="section-title">Application Overview</h2>
